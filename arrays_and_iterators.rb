...
a.include?(1)
a.reverse
a.reverse! # use ! at the end to change the original array
a.shuffle
a.push(30) # will append new element 30 to the end array
a << 25 # << known as shovel operator will also append new element to the end of the array
a.unshift("someelement") # will add element "some element" to the beginning of the array
a.pop # will remove the last element of the array and return 1
a.uniq # will remove all the duplicates and display (will not change the original array)
a.uniq! # will remove all the duplicates in the original array
...
a.each { |i| puts i } #In plain terms: For each element i in array y print the value of i
...
names = ["john", "doe", "alex", "perl"]
names.each { |randomvariablename| puts "Hello #{randomvariablename.capitalize}" }

#Using the select method to pickup all the odd numbers from an array a:
